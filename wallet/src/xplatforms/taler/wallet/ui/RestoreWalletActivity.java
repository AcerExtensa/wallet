...
public final class RestoreWalletActivity extends AbstractWalletActivity
{
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        //Log.d("EXDBG:", "RestoreWalletActivity onCreate!!!");
    ...
    private Dialog createRestoreWalletDialog()
    {
        ...
        dialog.setPositiveButton(R.string.import_keys_dialog_button_import, new OnClickListener()
        {
            ...
            {
                //Log.d("EXDBG:", "onClick -> restore!");

                final String password = passwordView.getText().toString().trim();
                //Log.d("EXDBG:", "Restore ps -> "+password);
                passwordView.setText(null); // get rid of it asap

                //Log.d("EXDBG", "Call handleRestore!");
    ...
    {
        //Log.d("EXDBG:", "RestoreWalletActivity -> handleRestore entry");
        try
        {
            ///Log.d("EXDBG:", "restore wallet -> p: "+password + " file: "+ backupFileUri);

            final InputStream is = contentResolver.openInputStream(backupFileUri);

            //Log.d("EXDBG:","restore wallet-> try to restoreWalletFromEncrypted");
            restoreWalletFromEncrypted(is, password);
            //Log.d("EXDBG:","restore wallet-> try to restoreWalletFromEncrypted end");
        ...
        {
            //Log.d("EXDBG:", "restore Wallet -> Catched exception here 210");
    ...
    {
        //Log.d("EXDBG:", "restoreWalletFromEncrypted function called");
       ...
       // Log.d("EXDBG:", "restore wallet -> cuph "+cipherText.toString() + " ps: "+password.toCharArray());
