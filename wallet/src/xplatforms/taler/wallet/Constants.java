...
public final class Constants {
    ...
    public static final NetworkParameters NETWORK_PARAMETERS = TalerCoinMain.get();
    ...
    public final static class Files
    {
        ...
        public static final String EXTERNAL_WALLET_KEY_BACKUP = "taler-wallet-keys" + FILENAME_NETWORK_SUFFIX;

        /** Filename of the manual wallet backup. */
        public static final String EXTERNAL_WALLET_BACKUP = "taler-wallet-backup" + FILENAME_NETWORK_SUFFIX;

        /** Suffix for the subject of the manual wallet backup. */
        public static final String EXTERNAL_WALLET_BACKUP_SUBJECT_SUFFIX = "";
    ...
    public static final String WALLET_NAME_CURRENCY_CODE = "tlr";

    /** URL to fetch version alerts from. */
    //public static final HttpUrl VERSION_URL = HttpUrl.parse("https://wallet.schildbach.de/version");
    public static final HttpUrl VERSION_URL = HttpUrl.parse("https://dev.taler.club/wallet_version");
    /** URL to fetch dynamic fees from. */
    //public static final HttpUrl DYNAMIC_FEES_URL = HttpUrl.parse("https://wallet.schildbach.de/fees");
    public static final HttpUrl DYNAMIC_FEES_URL = HttpUrl.parse("https://dev.taler.club/wallet_fees");
    ...
    public static final String USER_AGENT = "Taler Wallet Android";

    /** Default currency to use if all default mechanisms fail. */
    public static final String DEFAULT_EXCHANGE_CURRENCY = "BYN";

    /** Donation address for tip/donate action. */
    public static final String DONATION_ADDRESS = NETWORK_PARAMETERS.getId().equals(TalerCoinMain.ID_MAINNET)
            ? "TEU5bnWLXNzUmLtSs9AWsWjCqPYvRk6M44" : null;

    /** Recipient e-mail address for reports. */
    public static final String REPORT_EMAIL = "admin@xplatforms.de";
