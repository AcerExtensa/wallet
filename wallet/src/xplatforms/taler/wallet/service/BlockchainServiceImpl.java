...
package xplatforms.taler.wallet.service;
...
import xplatforms.taler.wallet.WalletBalanceWidgetProvider;
import xplatforms.taler.wallet.data.AddressBookProvider;
import xplatforms.taler.wallet.service.BlockchainState.Impediment;
import xplatforms.taler.wallet.ui.WalletActivity;
import xplatforms.taler.wallet.util.CrashReporter;
import xplatforms.taler.wallet.util.ThrottlingWalletChangeListener;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
    ...
    public void onCreate()
    {
       ...
       // Log.d("EXDBG:", "BlockchainService onCreate()");
...
//                            earliestKeyCreationTime);
    ...
    public int onStartCommand(final Intent intent, final int flags, final int startId)
    {
        if (intent != null)
        {
            ...
            {
               // Log.d("EXDBG:", "ACTION_BROADCAST_TRANSACTION");
                ...
                if (peerGroup != null)
                {
                   // Log.d("EXDBG:", "Broadcast transaction onStartCommand " + tx.getHashAsString());
                ...
                {
                   // Log.d("EXDBG:", "peergroup not available, not broadcasting transaction " + tx.getHashAsString());
    ...
    public void onDestroy()
    {
        ...
        Log.d("EXDBG:", "BlockchainService onDestroy()");
